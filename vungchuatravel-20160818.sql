...
CREATE TABLE `tb_menu` (
  ...
  `MN_DSP_TP` varchar(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'D' COMMENT 'Menu display type (D-Drop down list, L-Layout)',
  PRIMARY KEY (`MN_ID`)
...
-- Records of tb_menu
-- ----------------------------
INSERT INTO `tb_menu` VALUES ('MN001', '1', 'MG01', '0', null, 'Giới Thiệu', 'About Us', 'about', 'D');
INSERT INTO `tb_menu` VALUES ('MN002', '2', 'MG01', '0', null, 'Tours', 'Tours', 'tour', 'L');
INSERT INTO `tb_menu` VALUES ('MN003', '3', 'MG01', '0', null, 'Tin Tức', 'News', 'news', 'D');
INSERT INTO `tb_menu` VALUES ('MN004', '4', 'MG01', '0', null, 'Dịch Vụ', 'Services', 'services', 'D');
INSERT INTO `tb_menu` VALUES ('MN005', '5', 'MG01', '0', null, 'Khách Sạn', 'Hotel', 'hotel', 'D');
INSERT INTO `tb_menu` VALUES ('MN006', '6', 'MG01', '0', null, 'Nhà Hàng', 'Restaurant', 'restaurant', 'D');
INSERT INTO `tb_menu` VALUES ('MN007', '7', 'MG01', '0', null, 'Liên Hệ', 'Contact', 'contact', 'D');
INSERT INTO `tb_menu` VALUES ('MN008', '8', 'MG01', '0', null, 'Thanh Toán', 'Payment', 'payment', 'D');
INSERT INTO `tb_menu` VALUES ('MN009', '1', 'MG01', '1', 'MN002', 'Tour Quảng Bình đi', 'Tour from Quang Binh', 'tour-from-quang-binh', 'D');
INSERT INTO `tb_menu` VALUES ('MN010', '2', 'MG01', '1', 'MN002', 'Tour đến Quảng Bình', 'Tour to Quang Binh', 'tour-to-quang-binh', 'D');
INSERT INTO `tb_menu` VALUES ('MN011', '3', 'MG01', '1', 'MN002', 'Tour ghép hằng ngày', 'Daily group tours', 'daily-group-tour', 'D');
INSERT INTO `tb_menu` VALUES ('MN012', '4', 'MG01', '1', 'MN002', 'Tour trọn gói', 'Package tours', 'package-tour', 'D');
INSERT INTO `tb_menu` VALUES ('MN013', '1', 'MG01', '1', 'MN001', 'Vũng Chùa Travel', 'Vung Chua Travel', 'vung-chua-travel', 'D');
INSERT INTO `tb_menu` VALUES ('MN014', '2', 'MG01', '1', 'MN001', 'Thư Ngõ', 'Open Letter', 'open-letter', 'D');
INSERT INTO `tb_menu` VALUES ('MN015', '3', 'MG01', '1', 'MN001', 'Tầm Nhìn Chiến Lược', 'Strategic Vision', 'strategic-vision', 'D');
INSERT INTO `tb_menu` VALUES ('MN016', '1', 'MG01', '2', 'MN009', 'Free & Easy Tour', 'Free & Easy Tour', 'free-easy-tour', 'D');
INSERT INTO `tb_menu` VALUES ('MN017', '2', 'MG01', '2', 'MN009', 'Du Lịch Tâm Linh', 'Spiritual Travel', 'spriritual-travel', 'D');
INSERT INTO `tb_menu` VALUES ('MN018', '3', 'MG01', '2', 'MN009', 'Du Lịch Miền Nam - Đảo Phú Quốc', 'Western, Phu Quoc Island Tour', 'phu-quoc-island-tour', 'D');
INSERT INTO `tb_menu` VALUES ('MN019', '4', 'MG01', '2', 'MN009', 'Tour Theo Yêu Cầu', 'Tour on Request', 'tour-on-request', 'D');
...
CREATE TABLE `tb_slide` (
  ...
  `SLD_CONTENT` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'SLIDE CONTENT',
...
-- Records of tb_slide
-- ----------------------------
INSERT INTO `tb_slide` VALUES ('SL001', '1', 'Vung CHua Travel slide title', '<div class=\"sl-title-top\">Welcome to</div><div class=\"sl-title\">Dubai</div><div class=\"sl-title-bot\">Starting <span>$280</span> per night</div>', '/resources/assets/pic/slider/main/slide-1.jpg', 'Picture of a girl wearing custom printed yoga leggings', '#');
INSERT INTO `tb_slide` VALUES ('SL002', '2', 'Vung CHua Travel slide title 2', '<div class=\"sl-title-top\">Welcome to</div><div class=\"sl-title\">Istanbul</div><div class=\"sl-title-bot\">Starting <span>$255</span> per night</div>', '/resources/assets/pic/slider/main/slide-2.jpg', 'icture of a girl wearing a draped kimono', '#');
INSERT INTO `tb_slide` VALUES ('SL003', '3', 'Vung chua travel tour title 3', '<div class=\"sl-title-top\">Welcome to</div><div class=\"sl-title\">Honolulu</div><div class=\"sl-title-bot\">Starting <span>$105</span> per night</div>', '/resources/assets/pic/slider/main/slide-3.jpg', 'Picture of an artist workspac', '#');
INSERT INTO `tb_slide` VALUES ('SL004', '4', 'Vung chua Travel guides title 4', '<div class=\"sl-title-top\">Welcome to</div><div class=\"sl-title\">Istanbul</div><div class=\"sl-title-bot\">Starting <span>$255</span> per night</div>', '/resources/assets/pic/slider/main/slide-1.jpg', 'Picture of framed fine art prints', '#');
INSERT INTO `tb_slide` VALUES ('SL005', '5', 'Vung chua Travel guides title 5', '<div class=\"sl-title-top\">Welcome to</div><div class=\"sl-title\">Honolulu</div><div class=\"sl-title-bot\">Starting <span>$105</span> per night</div>', '/resources/assets/pic/slider/main/slide-2.jpg', 'Picture of a girl sewing products', '#');
